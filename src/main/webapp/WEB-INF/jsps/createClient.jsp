...
tel_home: <input type="text" name="tel_home"/>
tel_work: <input type="text" name="tel_work"/>
tel_cell: <input type="text" name="tel_cell"/>
...
<div>
  <a href="displayAllData" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">View All</a>
</div>
