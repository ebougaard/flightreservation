...
Location Number: <input type="text" name="locationNumber"/>
Company: <input type="text" name="company"/>
Location: <input type="text" name="location"/>
Date Of Appointment: <input type="text" name="dateOfAppointment"/>
Time: <input type="text" time="time"/>
...
<div>
  <a href="displayAppointments" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">View All</a>
</div>
